...
while True:
    ...
    draw.text((60, 2), 'MPU6050', fill = "RED", font=Font3)
    draw.text((2, 30),'Ax=' ,    fill = "BLACK", font=Font3)
    draw.text((60, 30),str(Ax) , fill = "BLUE", font=Font3)
    draw.text((2, 70),'Ay=' ,    fill = "BLACK", font=Font3)
    draw.text((60, 70),str(Ay) , fill = "GREEN", font=Font3)
    draw.text((2, 110),'Az=' ,   fill = "BLACK", font=Font3)
    draw.text((60, 110),str(Az) ,fill = "BLUE", font=Font3)
    draw.text((2, 150),'Gx=' ,   fill = "BLACK", font=Font3)
    draw.text((60, 150),str(Gx) ,fill = "GREEN", font=Font3)
    draw.text((2, 190),'Gy=' ,   fill = "BLACK", font=Font3)
    draw.text((60, 190),str(Gy) ,fill = "BLUE", font=Font3)
    draw.text((2, 230),'Gz=' ,   fill = "BLACK", font=Font3)
    draw.text((60, 230),str(Gz) ,fill = "GREEN", font=Font3)
